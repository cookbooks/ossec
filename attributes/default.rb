...
default['ossec']['user']['email']['enable'] = true
default['ossec']['user']['email']['address'] = "ossec@example.com"
default['ossec']['user']['email']['smtp'] = "127.0.0.1"
default['ossec']['user']['firewall_response'] = true
default['ossec']['user']['install_type'] = "local"
default['ossec']['user']['language'] = "en"
default['ossec']['user']['logs'] = ["/var/log/messages", "/var/log/auth.log", "/var/log/syslog", "/var/log/mail.info"]
default['ossec']['user']['pf'] = false
default['ossec']['user']['pf_table'] = false
default['ossec']['user']['remote_syslog']['enable'] = true
default['ossec']['user']['remote_syslog']['server'] = "syslog.example.com"
default['ossec']['user']['remote_syslog']['port'] = 514
default['ossec']['user']['remote_syslog']['level'] = default['ossec']['user']['alerts']['log_alert_level']
default['ossec']['user']['remote_syslog']['group'] = "ossec"
